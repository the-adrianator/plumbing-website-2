      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="contact-info">
            ...
            <p className="text-gray-700 mb-8">Have a plumbing emergency or need to schedule a service? Contact us today.</p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Emergency: <a href="tel:01234567890" className="text-primary hover:text-secondary transition-colors">01234 567 890</a></p>
                  <p className="text-gray-700">Office: <a href="tel:01234567891" className="text-primary hover:text-secondary transition-colors">01234 567 891</a></p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700"><a href="mailto:info@nelaplumbing.com" className="text-primary hover:text-secondary transition-colors">info@nelaplumbing.com</a></p>
                </div>
              </div>
